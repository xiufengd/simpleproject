...
public interface Constants {
	...
	/** 上次请求参数 */
	public static final String PREREQUEST_PARAM = "PREREQUEST_PARAM";
	/** 上次请求时间 */
	...
	/** 缓存命名空间 */
	public static final String CACHE_NAMESPACE = "Wecredo:";
	/** 政策服务的自定义表单sourceType **/
	String GOV_POLICY_SOURCE_TYPE = "policy_service";
}
